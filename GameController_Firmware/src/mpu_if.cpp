...
// void mpu_if::init(mpu_if::mpu_sensitivity sensi)
// {
//   Wire.begin();
...
// mpu_if::imuReadings mpu_if::getValues()
// {
//   // return if no data ready
//   mpu_if::imuReadings rc;
...
// void mpu_if::_requestReadI2c(uint8_t reg, uint8_t size)
// {
//   Wire.beginTransmission(_i2c_addr);
...
// void mpu_if::_writeI2cReg(uint8_t reg, uint8_t data)
// {
//   Wire.beginTransmission(_i2c_addr);
//   Wire.write(reg);
//   Wire.write(data);
